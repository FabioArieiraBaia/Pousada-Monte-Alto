...
export default function Footer() {
  ...
  return (
    <footer className="relative z-20 bg-stone-950 text-stone-300 pt-16 pb-12 border-t border-stone-800 shadow-2xl">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-3 pt-2">
              <a
                ...
                className="w-9 h-9 rounded-full bg-stone-900 border border-stone-800 hover:bg-amber-500 hover:text-stone-950 flex items-center justify-center transition-all shadow-sm"
                title="Instagram"
              >
          ...
          <div className="space-y-4">
            <h4 className="font-serif text-white font-bold text-base border-b border-stone-800 pb-2">
              {t('footer.quickLinks')}
            </h4>
            <ul className="space-y-2.5 text-xs sm:text-sm">
              ...
              <li>
                <Link to="/acomodacoes" className="text-stone-400 hover:text-amber-400 transition-colors">
                  {t('nav.accommodations')}
                </Link>
              </li>
              <li>
                <Link to="/sobre-localizacao" className="text-stone-400 hover:text-amber-400 transition-colors">
                  {t('nav.about')}
                </Link>
              </li>
              <li>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3 text-xs sm:text-sm text-stone-400">
              ...
              <li className="flex items-center gap-2.5 text-xs text-amber-400/90 font-medium">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2.5 text-xs text-stone-400">
              <div className="flex items-center gap-2 bg-stone-900/80 p-2.5 rounded-xl border border-stone-800">
